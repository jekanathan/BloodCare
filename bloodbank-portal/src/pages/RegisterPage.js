...
import { CheckCircle, Droplet, Upload, FileText, X, AlertCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const validateStep = () => {
    ...
    if (step === 2) {
      if (!form.bankName || !form.registrationNumber || !form.type || !form.address || !form.district || !form.province) {
        setError('Please fill in all blood bank detail fields.');
        return false;
      }
    }
    if (step === 3) {
      if (!docs.bloodBankLicense || !docs.registrationCertificate) {
        setError('Blood Bank License and Registration Certificate are required.');
        return false;
      }
    }
    if (step === 4) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post('/bloodbank-auth/register', formData, {
      ...
      <div className="auth-right">
        <div className="auth-form-wrap" style={{ textAlign: 'center' }}>
          ...
          <div className="auth-form-sub" style={{ marginBottom: 28 }}>
            Your blood bank registration and documents have been submitted for review. Admin will verify your details and approve within 24–48 hours.
          </div>
    ...
    <div className="auth-page">
      <div className="auth-left">
        <div className="auth-brand anim-up">
          <div className="auth-logo-box"><Droplet size={30} color="#fff" /></div>
          <div className="auth-brand-name">Blood<span>Care</span></div>
          <div className="auth-brand-sub">Register your blood bank</div>
          ...
          <ul className="auth-features" style={{ marginTop: 32 }}>
            ...
            <li><span>✓</span>Manage blood stock & inventory</li>
            <li><span>✓</span>Connect to hospitals island-wide</li>
            <li><span>✓</span>Real-time request notifications</li>
          </ul>
        </div>
      </div>
        ...
        <div className="auth-form-wrap anim-up" style={{ maxWidth: 480 }}>
          ...
          {step === 1 && (
            <form onSubmit={handleNext} className="anim-up">
              ...
              <div className="auth-form-sub">Who is the primary contact for this blood bank?</div>

              <div className="form-group">
                <label className="form-label">Contact Person Name</label>
                <input className="form-input" placeholder="Mr. Kamal Silva" value={form.contactPerson} onChange={e => set('contactPerson', e.target.value)} required />
              </div>
              <div className="form-group">
                <label className="form-label">Designation</label>
                <input className="form-input" placeholder="Blood Bank Manager" value={form.designation} onChange={e => set('designation', e.target.value)} required />
              </div>
              <div className="form-row">
                <div className="form-group">
                  <label className="form-label">Official Email</label>
                  <input type="email" className="form-input" placeholder="info@bloodbank.lk" value={form.email} onChange={e => set('email', e.target.value)} required />
                </div>
                <div className="form-group">
          ...
          {step === 2 && (
            <form onSubmit={handleNext} className="anim-up">
              <div className="auth-form-title">Blood Bank Details 🏦</div>
              ...
              <div className="form-group">
                ...
                <input className="form-input" placeholder="National Blood Bank" value={form.bankName} onChange={e => set('bankName', e.target.value)} required />
              </div>
              <div className="form-row">
                <div className="form-group">
                  <label className="form-label">Registration No.</label>
                  <input className="form-input" placeholder="BB-2026-00125" value={form.registrationNumber} onChange={e => set('registrationNumber', e.target.value)} required />
                </div>
                <div className="form-group">
                  <label className="form-label">Blood Bank Type</label>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input className="form-input" placeholder="BBL/2024/5567" value={form.licenseNumber} onChange={e => set('licenseNumber', e.target.value)} />
                </div>
                <div className="form-group">
          ...
          {step === 3 && (
            <form onSubmit={handleNext} className="anim-up">
              ...
              {[
                { key: 'bloodBankLicense', label: 'Blood Bank License', required: true },
          ...
          {step === 4 && (
            <form onSubmit={handleSubmit} className="anim-up">
              ...
              <div className="auth-form-sub">Set a password to access your blood bank dashboard once approved</div>
